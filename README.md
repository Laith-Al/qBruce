...
A qFlipper-style Windows app for devices running **Bruce Firmware**.
...
*If the Wifi SSID Feature Isn't Working, Make sure that you have location services enabled*
